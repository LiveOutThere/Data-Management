...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_F12_SW]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_F12_SW]

CREATE TABLE [dbo].[tbl_LoadFile_F12_SW](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_store]  DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_websites]  DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_attribute_set]  DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_status]  DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_tax_class]  DEFAULT ('Taxable Goods'),
	[gender] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_visibility]  DEFAULT ('Not Visible Individually'),
	...
	[season] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_season]  DEFAULT (N'FW12'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_manufacturer]  DEFAULT ('Smartwool'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_qty]  DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_is_in_stock]  DEFAULT ((0)),
	...
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_backorders]  DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_manage_stock]  DEFAULT ((1))
 CONSTRAINT [PK_tbl_LoadFile_F12_SW] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_F12_SW] ON [dbo].[tbl_LoadFile_F12_SW] 
(
	[sku] ASC,
	[type] ASC,
...
INSERT INTO tbl_LoadFile_F12_SW (
		sku,
		vendor_product_id,
		[name],
		gender,
...
SELECT  dbo.getMagentoSimpleSKU('SW', a.[Style #], a.[Color #], REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a.[Product Size],'3T','O/S'),'24M','O/S'),'12M','O/S'),'6M','O/S'),'1SFM','O/S')) AS sku,
		...
		REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a.[Product Size],'3T','O/S'),'24M','O/S'),'12M','O/S'),'6M','O/S'),'1SFM','O/S') AS choose_size,
		a.[Color #] AS vendor_color_code,
		REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a.[Product Size],'3T','O/S'),'24M','O/S'),'12M','O/S'),'6M','O/S'),'1SFM','O/S') AS vendor_size_code,
		CAST(a.[UPC Number:] AS bigint) AS vendor_sku,
		CAST(a.[S12 Retail] AS float) -.01 AS price,
		a.[S12 WS] AS cost,
		0 AS has_options,
		'simple' AS type,
		dbo.getSWImage(a.[Style #],a.[Color #]) AS image,
		dbo.getSWColorName(a.[Color Name]) AS image_label,
		dbo.getUrlKey(dbo.getSWName(a.[Style Name],a.[Product SubCategory]), 'Smartwool', dbo.getSWColorName(a.[Color Name]) + ' - ' + REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a.[Product Size],'3T','O/S'),'24M','O/S'),'12M','O/S'),'6M','O/S'),'1SFM','O/S')) AS url_key
FROM tbl_RawData_F12_SW AS a

--DELETE FROM tbl_LoadFile_F12_SW WHERE name IS NULL OR image IS NULL
...
SELECT DISTINCT
	    dbo.getMagentoConfigurableSKU('SW', a.[Style #]) AS sku,
		'choose_color,choose_size' AS configurable_attributes,
		a.[Style #] AS vendor_product_id,
		'Uncategorized' AS categories,
		dbo.getSWName(a.[Style Name],a.[Product SubCategory]) AS name,
		dbo.getSWGender(a.[Style Name],a.[Product SubCategory]) AS gender,
		(SELECT MAX(price) FROM tbl_LoadFile_F12_SW WHERE vendor_product_id = a.[Style #]) AS price,
		(SELECT MAX(cost) FROM tbl_LoadFile_F12_SW WHERE vendor_product_id = a.[Style #]) AS cost,
		'1' AS has_options,
		'configurable' AS type,
		dbo.getUrlKey(dbo.getSWName(a.[Style Name],a.[Product SubCategory]), 'Smartwool', '') AS url_key,
...
UPDATE a SET
	description = dbo.getSWDesc(a.vendor_product_id),
	features = dbo.getSWFeatures(a.vendor_product_id),
	fabric = dbo.getSWFabric(a.vendor_product_id),
	care_instructions = dbo.getSWCareInfo(a.vendor_product_id),
	image = (SELECT TOP 1 image FROM tbl_LoadFile_F12_SW WHERE vendor_product_id = a.vendor_product_id ORDER BY choose_color DESC),
	image_label = (SELECT TOP 1 image_label FROM tbl_LoadFile_F12_SW WHERE vendor_product_id = a.vendor_product_id ORDER BY choose_color DESC)
FROM tbl_LoadFile_F12_SW AS a
...
--DELETE FROM tbl_LoadFile_F12_SW WHERE image IS NULL AND type = 'configurable'

UPDATE tbl_LoadFile_F12_SW SET thumbnail = '+' + image, small_image = '+' + image WHERE image IS NOT NULL
UPDATE tbl_LoadFile_F12_SW SET image = '+' + image WHERE image IS NOT NULL

GO
CREATE VIEW [dbo].[view_LoadFile_F12_SW]
AS
...
FROM dbo.tbl_LoadFile_F12_SW AS a
GO

DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_F12_SW" queryout "C:\Data\Shared\SW.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql

DROP VIEW view_LoadFile_F12_SW
