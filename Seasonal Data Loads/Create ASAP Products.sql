...
FROM dbo.tbl_LoadFile_F12_TNF AS a WHERE a.image IS NOT NULL AND a.sku NOT IN (SELECT sku FROM temp_Magento_FW12I)
GO

SELECT * FROM LOT_Inventory.dbo.view_LoadFile_F12_TNF

DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_F12_TNF" queryout "C:\Data\Shared\_TNF.csv" -w -t , -T -S ' + @@servername
