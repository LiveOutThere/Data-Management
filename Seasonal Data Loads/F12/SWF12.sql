...
CREATE TABLE [dbo].[tbl_LoadFile_F12_SW](
	...
	[season] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_F12_SW_season]  DEFAULT (N'FW12A'),
...
FROM dbo.tbl_LoadFile_F12_SW AS a WHERE a.image IS NOT NULL
GO
