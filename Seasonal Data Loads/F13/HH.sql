...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_FW13_HH]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_FW13_HH]

CREATE TABLE [dbo].[tbl_LoadFile_FW13_HH](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_store]  DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_websites]  DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_attribute_set]  DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_status]  DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_tax_class]  DEFAULT ('Taxable Goods'),
	[department] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_visibility]  DEFAULT ('Not Visible Individually'),
	...
	[season_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_season]  DEFAULT (N'FW13 ASAP'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_manufacturer]  DEFAULT ('Helly Hansen'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_qty]  DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_is_in_stock]  DEFAULT ((0)),
	...
	[never_backorder] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_never_backorder]  DEFAULT ((0)),
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_backorders]  DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_manage_stock]  DEFAULT ((1)),
	[use_config_backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_use_config_backorders]  DEFAULT ((0)),
	[use_config_manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW13_HH_use_config_manage_stock]  DEFAULT ((1))
 CONSTRAINT [PK_tbl_LoadFile_FW13_HH] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_FW13_HH] ON [dbo].[tbl_LoadFile_FW13_HH] 
(
	[sku] ASC,
	[type] ASC,
...
GO
TRUNCATE TABLE tbl_LoadFile_FW13_HH

GO
INSERT INTO tbl_LoadFile_FW13_HH (
		[type]		
		,sku
		,[name]
		,has_options
...
SELECT DISTINCT
	...
	,dbo.getUrlKey(dbo.getHHName(StyleName),'Helly Hansen',dbo.getHHColorName(ColorName) + '-' + dbo.getHHSize(LTRIM(RTRIM(Size))),dbo.getHHDepartment(Gender)) + '-fw13a' AS url_key
	,NULL AS weight
...
UPDATE a
	SET a.image = b.image
FROM tbl_LoadFile_FW13_HH AS a
INNER JOIN tbl_LoadFile_SS13_HH AS b
...
WHERE b.Brand = 'HH' AND a.type = 'simple' AND a.image IS NULL
...
UPDATE tbl_LoadFile_FW13_HH SET
	...
	,description = (SELECT TOP 1 Product_Statement FROM tbl_RawData_FW13_HH_UPC_Marketing_Price WHERE Style = a.vendor_product_id)
	,features = (SELECT TOP 1 Product_Features FROM tbl_RawData_FW13_HH_UPC_Marketing_Price WHERE Style = a.vendor_product_id)
	,fabric = (SELECT TOP 1 Fabric_Content FROM tbl_RawData_FW13_HH_UPC_Marketing_Price WHERE Style = a.vendor_product_id)
	,simples_skus = (SELECT TOP 1 dbo.getHHAssociatedProducts(Style) FROM tbl_RawData_FW13_HH_UPC_Marketing_Price WHERE Style = a.vendor_product_id)
FROM tbl_LoadFile_FW13_HH AS a
WHERE type = 'configurable'

GO	
UPDATE tbl_LoadFile_FW13_HH SET categories = dbo.getCategory(categories,'Helly Hansen',department) WHERE type = 'configurable'
UPDATE tbl_LoadFile_FW13_HH SET categories = NULL WHERE type = 'simple'
UPDATE tbl_LoadFile_FW13_HH SET status = 'Disabled' WHERE image IS NULL AND type = 'simple'
UPDATE tbl_LoadFile_FW13_HH SET thumbnail = image, small_image = image WHERE type = 'simple'
GO

CREATE VIEW [dbo].[view_LoadFile_FW13_HH]
AS
...
FROM dbo.tbl_LoadFile_FW13_HH AS a
GO

DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_FW13_HH" queryout "C:\Data\Shared\FW13HH.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql

DROP VIEW view_LoadFile_FW13_HH	
