...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_FW14_COLF]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_FW14_COLF]

CREATE TABLE [dbo].[tbl_LoadFile_FW14_COLF](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_store]  DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_websites]  DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_attribute_set]  DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[super_attribute_pricing] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_status]  DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_tax_class]  DEFAULT ('Taxable Goods'),
	[department] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_visibility]  DEFAULT ('Not Visible Individually'),
	...
	[season_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_season]  DEFAULT (N'FW14 ASAP'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_manufacturer]  DEFAULT ('Columbia Footwear'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_qty]  DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_is_in_stock]  DEFAULT ((0)),
	...
	[never_backorder] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_never_backorder]  DEFAULT ((0)),
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_backorders]  DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_manage_stock]  DEFAULT ((1)),
	[use_config_backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_use_config_backorders]  DEFAULT ((0)),
	[use_config_manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_COLF_use_config_manage_stock]  DEFAULT ((1))
 CONSTRAINT [PK_tbl_LoadFile_FW14_COLF] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_FW14_COLF] ON [dbo].[tbl_LoadFile_FW14_COLF] 
(
	[sku] ASC,
	[type] ASC,
...
GO
TRUNCATE TABLE tbl_LoadFile_FW14_COLF

GO
INSERT INTO tbl_LoadFile_FW14_COLF (
		[type]		
		,sku
		,[name]
		,has_options
...
SELECT DISTINCT
	'simple' AS type
	,'FW14-COLF-' + LEFT(CONVERT(varchar(255),CAST(a.[Material Number] AS decimal)),7) + '-' + CASE WHEN LEN(a.[Colorway Number]) = 1 THEN '00' + CAST(a.[Colorway Number] AS varchar(255)) WHEN LEN(a.[Colorway Number]) = 2 THEN '0' + CAST(a.[Colorway Number] AS varchar(255)) ELSE CAST(a.[Colorway Number] AS varchar(255)) END + '-' + dbo.getCOLSize(a.[Size Code],a.[Dimension Code]) AS sku
	...
	,NULL AS weight
FROM tbl_RawData_FW14_COLF_UPC_Marketing AS a
INNER JOIN tbl_RawData_FW14_COLF_Price AS b
ON LEFT(a.[Material Number],7) = b.Material
GO

UPDATE a
	SET a.image = b.image
FROM tbl_LoadFile_FW14_COLF AS a
...
SELECT DISTINCT
	...
	,dbo.getUrlKey(name,'Columbia Footwear','',department) AS url_key
	,'Columbia Footwear ' + REPLACE(REPLACE(department + '''s ','Men|Women''s ',''),'Boy|Girl''s ','') + name AS meta_title
	,'F' AS merchandise_priority
	,0 AS manage_stock
	,0 AS use_config_manage_stock
	,NULL AS qty
	,NULL AS is_in_stock
FROM tbl_LoadFile_FW14_COLF
GO

UPDATE tbl_LoadFile_FW14_COLF SET
	 categories = dbo.getMagentoCategories(a.vendor_product_id)
	,fabric = (SELECT TOP 1 [Catalog Fabric] FROM tbl_RawData_FW14_COLF_UPC_Marketing WHERE LEFT([Material Number],7) = a.vendor_product_id)
	,features = (SELECT TOP 1 [Catalog Features] FROM tbl_RawData_FW14_COLF_UPC_Marketing WHERE LEFT([Material Number],7) = a.vendor_product_id)
	,fit = (SELECT TOP 1 [Fit Description] FROM tbl_RawData_FW14_COLF_UPC_Marketing WHERE LEFT([Material Number],7) = a.vendor_product_id)
	,simples_skus = dbo.getCOLassociatedProducts(a.vendor_product_id)
FROM tbl_LoadFile_FW14_COLF AS a
WHERE type = 'configurable'
GO
	
UPDATE tbl_LoadFile_FW14_COLF SET thumbnail = image, small_image = image WHERE type = 'simple'
GO

/*
CREATE VIEW [dbo].[view_LoadFile_FW14_COL]
AS
...
FROM dbo.tbl_LoadFile_FW14_COL AS a
GO

DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_FW14_COL" queryout "C:\Data\Shared\FW14COL.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql

DROP VIEW view_LoadFile_FW14_COL
*/
