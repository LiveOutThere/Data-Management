...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_FW14_OSP]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_FW14_OSP]

CREATE TABLE [dbo].[tbl_LoadFile_FW14_OSP](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_store]  DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_websites]  DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_attribute_set]  DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[super_attribute_pricing] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_status]  DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_tax_class]  DEFAULT ('Taxable Goods'),
	[department] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_visibility]  DEFAULT ('Not Visible Individually'),
	...
	[season_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_season]  DEFAULT (N'FW14 ASAP'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_manufacturer]  DEFAULT ('Osprey'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_qty]  DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_is_in_stock]  DEFAULT ((0)),
	...
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_backorders]  DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[use_config_backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_use_config_backorders]  DEFAULT ((0)),
	[use_config_manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_OSP_use_config_manage_stock]  DEFAULT ((1))
 CONSTRAINT [PK_tbl_LoadFile_FW14_OSP] PRIMARY KEY CLUSTERED 
(
		[id] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_FW14_OSP] ON [dbo].[tbl_LoadFile_FW14_OSP] 
(
	[sku] ASC,
	[type] ASC,
...
TRUNCATE TABLE tbl_LoadFile_FW14_OSP
GO

INSERT INTO tbl_LoadFile_FW14_OSP (
		[type]		
		,sku
		,[name]
		,has_options
...
SELECT DISTINCT
	'simple' AS type
	,('FW14-OSP-' + CAST(LEFT(CONVERT(varchar(255),StyleColor),6) AS varchar(255)) + '-' + CASE WHEN CAST(F5 AS varchar(255)) = '0' THEN '000' ELSE CAST(F5 AS varchar(255)) END + '-' + dbo.getOSPSize(Size))AS sku
	,dbo.getOSPName(Product)								AS name
	,0														AS has_options
	,CASE WHEN LEFT(StyleColor,2) = '01' THEN 'Men' WHEN LEFT(StyleColor,2) = '02' THEN 'Women' ELSE
	dbo.getOSPDepartment(Product,Size) END					AS department
	,dbo.ProperCase(Color)									AS image_label 
	,dbo.ProperCase(Color)									AS choose_color
	,dbo.getOSPSize(Size)									AS choose_size
	,CAST(UPC AS bigint)									AS vendor_sku
	,CAST(LEFT((StyleColor),6) AS varchar(255))				AS vendor_product_id
	...
	,CAST(Retail_Price AS float) - 0.01 AS price
	,CAST(Wholesale_Price AS float) AS cost
FROM tbl_RawData_FW14_OSP_UPC
GO

UPDATE a SET 
	a.image = b.image 
FROM tbl_LoadFile_FW14_OSP AS a
INNER JOIN tbl_LoadFile_FW13_OSP AS b
...
UPDATE a SET 
	a.image = b.image 
FROM tbl_LoadFile_FW14_OSP AS a
INNER JOIN tbl_LoadFile_SS14_OSP AS b
ON a.vendor_sku = b.vendor_sku
WHERE a.type = 'simple'
	 
UPDATE a SET
	a.image = b.Filename
FROM tbl_LoadFile_SS14_OSP AS a 
INNER JOIN [tbl_RawData_FW14_OSP_Photos] AS b 
...
FROM tbl_LoadFile_FW14_OSP
GO
select * from tbl_LoadFile_FW14_OSP where description IS NOT NULL
UPDATE a SET 
	categories = dbo.getMagentoCategories(a.vendor_product_id),
	features = dbo.getOSPFeatures(a.vendor_product_id),
	description = (SELECT TOP 1 Description FROM tbl_RawData_FW14_OSP_Price_Marketing WHERE Style = a.vendor_product_id),
...
UPDATE tbl_LoadFile_FW14_OSP SET videos = (SELECT TOP 1 SUBSTRING(Youtube,CHARINDEX('=',Youtube)+1,LEN(Youtube)) FROM tbl_RawData_FW13_OSP_Video WHERE Style1 = vendor_product_id AND type = 'configurable')
UPDATE tbl_LoadFile_FW14_OSP SET categories = NULL WHERE type = 'simple'
UPDATE tbl_LoadFile_FW14_OSP SET status = 'Disabled' WHERE image IS NULL AND type = 'simple'
UPDATE tbl_LoadFile_FW14_OSP SET small_image = image, thumbnail = image
GO

UPDATE tbl_LoadFile_FW14_OSP --Final update on descriptions for SEO keywords
...
+ (SELECT TOP 1 Description FROM tbl_RawData_FW14_OSP_Price_Marketing WHERE Style = vendor_product_id)

--CREATE VIEW [dbo].[view_LoadFile_FW14_OSP]
--AS
...
--FROM dbo.tbl_LoadFile_FW14_OSP AS a
--GO

--DECLARE @sql varchar(1024)
--SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_FW14_OSP" queryout "C:\Data\Shared\FW14OSP.csv" -w -t , -T -S ' + @@servername
--EXEC master..xp_cmdshell @sql

--DROP VIEW view_LoadFile_FW14_OSP
