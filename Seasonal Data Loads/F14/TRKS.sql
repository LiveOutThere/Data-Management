...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_FW14_TRKS]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_FW14_TRKS]

CREATE TABLE [dbo].[tbl_LoadFile_FW14_TRKS](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_store]  DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_websites]  DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_attribute_set]  DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[super_attribute_pricing] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_status]  DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_tax_class]  DEFAULT ('Taxable Goods'),
	[department] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_visibility]  DEFAULT ('Not Visible Individually'),
	...
	[season_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_season]  DEFAULT (N'FW14 ASAP'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_manufacturer]  DEFAULT ('Tracks'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_qty]  DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_is_in_stock]  DEFAULT ((0)),
	...
	[never_backorder] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_never_backorder]  DEFAULT ((0)),
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_backorders]  DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_manage_stock]  DEFAULT ((1)),
	[use_config_backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_use_config_backorders]  DEFAULT ((0)),
	[use_config_manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_FW14_TRKS_use_config_manage_stock]  DEFAULT ((1))
 CONSTRAINT [PK_tbl_LoadFile_FW14_TRKS] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_FW14_TRKS] ON [dbo].[tbl_LoadFile_FW14_TRKS] 
(
	[sku] ASC,
	[type] ASC,
...
GO
TRUNCATE TABLE tbl_LoadFile_FW14_TRKS

GO
INSERT INTO tbl_LoadFile_FW14_TRKS (
		[type]		
		,sku
		,[name]
		,has_options
...
SELECT DISTINCT
	'simple' AS type
	,'FW14-TRKS-' + CAST([Part Number] AS varchar(255)) + CASE WHEN Size IS NULL THEN + '' ELSE + '-' + Size END AS sku
	,/*dbo.getTRKSName*/[Product Name] AS name
	,0 AS has_options
	,CAST(MSRP AS float) AS price
	--,CAST(ROUND(TRKSP,0) AS float) - 0.01 AS price
	...
	,NULL AS weight
FROM tbl_RawData_FW14_TRKS_UPC_Marketing
GO

/*
UPDATE a
	SET a.image = RIGHT(b.filename,CHARINDEX('/',REVERSE(b.filename)) - 1)
FROM tbl_LoadFile_FW14_TRKS AS a
...
SELECT DISTINCT
	...
	,dbo.getUrlKey(name,'Tracks','',department) AS url_key
	,'Tracks ' + REPLACE(REPLACE(department + '''s ','Men|Women''s ',''),'Boy|Girl''s ','') + name AS meta_title
	,'F' AS merchandise_priority
	,0 AS manage_stock
	,0 AS use_config_manage_stock
	,NULL AS qty
	,NULL AS is_in_stock
FROM tbl_LoadFile_FW14_TRKS
GO

UPDATE tbl_LoadFile_FW14_TRKS SET
	 categories = dbo.getMagentoCategories(a.vendor_product_id)
	,description = (SELECT TOP 1 [Long Description] FROM tbl_RawData_FW14_TRKS_UPC_Marketing WHERE [Part Number] = a.vendor_product_id)	
	,simples_skus = dbo.getTRKSAssociatedProducts(a.vendor_product_id)
FROM tbl_LoadFile_FW14_TRKS AS a
WHERE type = 'configurable'
GO
	
UPDATE tbl_LoadFile_FW14_TRKS SET categories = NULL WHERE type = 'simple'
UPDATE tbl_LoadFile_FW14_TRKS SET status = 'Disabled' WHERE image IS NULL AND type = 'simple'
UPDATE tbl_LoadFile_FW14_TRKS SET thumbnail = image, small_image = image WHERE type = 'simple'
GO

/*
CREATE VIEW [dbo].[view_LoadFile_FW14_TRKS]
AS
...
FROM dbo.tbl_LoadFile_FW14_TRKS AS a
GO

DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_FW14_TRKS" queryout "C:\Data\Shared\FW14TRKS.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql

DROP VIEW view_LoadFile_FW14_TRKS
*/
