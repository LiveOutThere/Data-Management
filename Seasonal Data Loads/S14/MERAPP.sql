...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_SS14_MERAPP]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_SS14_MERAPP]
 
CREATE TABLE [dbo].[tbl_LoadFile_SS14_MERAPP](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_store] DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_websites] DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_attribute_set] DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[super_attribute_pricing] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_status] DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_tax_class] DEFAULT ('Taxable Goods'),
	[department] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_visibility] DEFAULT ('Not Visible Individually'),
	...
	[season_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_season] DEFAULT ('SS14 ASAP'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_manufacturer] DEFAULT ('Merrell'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_qty] DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_is_in_stock] DEFAULT ((0)),
	...
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_backorders] DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[use_config_backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_use_config_backorders] DEFAULT ((0)),
	[use_config_manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_MERAPP_use_config_manage_stock] DEFAULT ((1))
	
 CONSTRAINT [PK_tbl_LoadFile_SS14_MERAPP] PRIMARY KEY CLUSTERED 
(
		[id] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
 
CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_SS14_MERAPP] ON [dbo].[tbl_LoadFile_SS14_MERAPP] 
(
	[sku] ASC,
	[type] ASC,
...
TRUNCATE TABLE tbl_LoadFile_SS14_MERAPP
 
GO
INSERT INTO tbl_LoadFile_SS14_MERAPP (
		 type		
		,sku
		,name
		,has_options
...
SELECT DISTINCT 
	'simple'												AS type
 	,'SS14A-MERAPP-' + LEFT(Stock#,8) + '-' + RIGHT(Stock#,3) + '-' + dbo.getMERAPPSize(Size) AS sku												
	,dbo.getMERAPPName(Name)							    AS name
	,0														AS has_options
	,CAST(MSRP AS float) - .01								AS price
	,WHSL													AS cost
	,dbo.getMERAPPDepartment(Gender)						AS department	
	,'Not Visible Individually'								AS visibility
	,dbo.getMERAPPColor(Colorway)							AS image_label 
	,dbo.getMERAPPColor(Colorway)							AS choose_color 
 	,dbo.getMERAPPSize(Size)								AS choose_size
 	,CASE WHEN LEN(UPC) = 11 THEN '0' + UPC ELSE UPC END	AS vendor_sku
	,LEFT(Stock#,8)											AS vendor_product_id
	,RIGHT(Stock#,3)										AS vendor_color_code 
	,dbo.getMERAPPSize(Size)			 					AS vendor_size_code 
	,0														AS never_backorder
	,1														AS manage_stock 
	,1														AS use_config_manage_stock
FROM tbl_RawData_SS14_MERAPP_UPC_Price
GO
...
FROM dbo.tbl_LoadFile_SS14_MERAPP
GO

UPDATE a SET
	a.image = b.Filename
FROM tbl_LoadFile_SS14_MERAPP AS a 
...
UPDATE tbl_LoadFile_SS14_MERAPP SET
...
UPDATE tbl_LoadFile_SS14_MERAPP SET categories = NULL WHERE type = 'simple'
UPDATE tbl_LoadFile_SS14_MERAPP SET status = 'Disabled' WHERE image IS NULL AND type = 'simple'
UPDATE tbl_LoadFile_SS14_MERAPP SET thumbnail = image, small_image = image WHERE type = 'simple'
GO
/* 
CREATE VIEW [dbo].[view_LoadFile_SS14_MERAPP]
AS
...
FROM dbo.tbl_LoadFile_SS14_MERAPP AS a
GO
 
DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_SS14_MERAPP" queryout "C:\Data\Shared\SS14MERAPP.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql
 
DROP VIEW view_LoadFile_SS14_MERAPP
*/