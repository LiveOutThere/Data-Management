...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[tbl_LoadFile_SS14_SW]')
AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[tbl_LoadFile_SS14_SW]
GO

CREATE TABLE [dbo].[tbl_LoadFile_SS14_SW](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[store] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_store]  DEFAULT ('admin'),
	[websites] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_websites]  DEFAULT ('base'),
	[type] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[sku] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[name] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[categories] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[attribute_set] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_attribute_set]  DEFAULT ('default'),
	[configurable_attributes] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[has_options] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[price] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[cost] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[super_attribute_pricing] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[status] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_status]  DEFAULT ('Enabled'),
	[tax_class_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_tax_class]  DEFAULT ('Taxable Goods'),
	[department] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[visibility] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_visibility]  DEFAULT ('Not Visible Individually'),
	...
	[season_id] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_season]  DEFAULT (N'SS14 ASAP'),
	...
	[manufacturer] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_manufacturer]  DEFAULT ('SmartWool'),
	[qty] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_qty]  DEFAULT ((0)),
	[is_in_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_is_in_stock]  DEFAULT ((0)),
	...
	[never_backorder] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_never_backorder]  DEFAULT ((0)),
	[backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_backorders]  DEFAULT ((0)),
	[manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_manage_stock]  DEFAULT ((1)),
	[use_config_backorders] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_use_config_backorders]  DEFAULT ((0)),
	[use_config_manage_stock] [nvarchar](4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_LoadFile_SS14_SW_use_config_manage_stock]  DEFAULT ((1))
 CONSTRAINT [PK_tbl_LoadFile_SS14_SW] PRIMARY KEY CLUSTERED 
(
	[id] ASC
...
CREATE NONCLUSTERED INDEX [IX_tbl_LoadFile_SS14_SW] ON [dbo].[tbl_LoadFile_SS14_SW] 
(
	[sku] ASC,
	[type] ASC,
...
TRUNCATE TABLE tbl_LoadFile_SS14_SW
GO

INSERT INTO tbl_LoadFile_SS14_SW (
		[type]		
		,sku
		,[name]
		,has_options
...
SELECT DISTINCT
	 'simple'													AS type
	,'SS14A-SW-' + a.StyleNumberRevised + '-' + a.ColorNumber + '-' + SUBSTRING(a.SKUNumber,11,LEN(a.SKUNumber)) AS sku
	,dbo.getSWName(b.[Style Name])										AS name
	,0															AS has_options
	,b.[Retail ]													AS price
	,b.WholeSale												AS cost
	,dbo.getSWDepartment(b.[Style Name])								AS department
	,NULL														AS image
	,dbo.getSWColorName(a.ColorName)							AS image_label
	,dbo.getSWColorName(a.ColorName)							AS choose_color
	,SUBSTRING(a.SKUNumber,11,LEN(a.SKUNumber))			AS choose_size
	,CAST(a.UPC AS bigint)										AS vendor_sku
	,a.StyleNumberRevised												AS vendor_product_id
	,a.ColorNumber												AS vendor_color_code
	,SUBSTRING(a.SKUNumber,11,LEN(a.SKUNumber))			AS vendor_size_code
FROM tbl_RawData_SS14_SW_UPC AS a
INNER JOIN tbl_RawData_SS14_SW_Price AS b
ON a.StyleNumberRevised = b.Style
GO	

DELETE FROM tbl_LoadFile_SS14_SW WHERE price IS NULL OR cost IS NULL
...
FROM tbl_LoadFile_SS14_SW
GO	

UPDATE a SET
	a.care_instructions	  = dbo.getSWCareInfo(a.vendor_product_id),
	a.simples_skus		  = dbo.getSWAssociatedProducts(a.vendor_product_id),
	a.categories		  = dbo.getMagentoCategories(a.vendor_product_id),
	a.fabric			  = (SELECT TOP 1 dbo.getSWFabric([MERINO WOOL CONTENT],[NYLON CONTENT],[ELASTANE CONTENT],[POLYESTER CONTENT],[ACRYLIC CONTENT]) FROM tbl_RawData_SS14_SW_Marketing WHERE [STYLE NUMBER] = a.vendor_product_id),
	a.description	      = dbo.getSWLDesc(a.vendor_product_id),
	a.features		      = dbo.getSWFeatures(a.vendor_product_id)
FROM tbl_LoadFile_SS14_SW AS a
...
UPDATE a
	SET a.image = b.image
FROM tbl_LoadFile_SS14_SW AS a
INNER JOIN tbl_LoadFile_FW13_SW AS b
...
FROM dbo.tbl_LoadFile_SS14_SW AS a
GO

DECLARE @sql varchar(1024)
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_LoadFile_SS14_SW" queryout "C:\Data\Shared\SS14SW.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql

DROP VIEW view_LoadFile_SS14_SW