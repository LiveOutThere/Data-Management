...
CREATE VIEW [dbo].[view_PAT_SEO_Update]
AS
...
SELECT @sql = 'bcp "SELECT * FROM LOT_Inventory.dbo.view_PAT_SEO_Update" queryout "C:\Data\Shared\SS13PATSEOUPDT.csv" -w -t , -T -S ' + @@servername
EXEC master..xp_cmdshell @sql

DROP VIEW view_PAT_SEO_Update
