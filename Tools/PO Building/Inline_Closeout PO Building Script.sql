...
BEGIN
	...
	SELECT 'SL856-001-S' UNION ALL
	SELECT 'SL856-001-M' UNION ALL
	SELECT 'SL856-001-L' UNION ALL
	SELECT 'SL856-001-XL' UNION ALL
	SELECT 'SL521-018-S' UNION ALL
	SELECT 'SL521-018-M' UNION ALL
	SELECT 'SL521-018-L' UNION ALL
	SELECT 'SL521-018-XL' UNION ALL
	SELECT 'SL858-018-S' UNION ALL
	SELECT 'SL858-018-M' UNION ALL
	SELECT 'SL858-018-L' UNION ALL
	SELECT 'SL858-018-XL' UNION ALL
	SELECT 'SS616-307-S' UNION ALL
	SELECT 'SS616-307-M' UNION ALL
	SELECT 'SS616-307-L' UNION ALL
	SELECT 'SS616-307-XL' UNION ALL
	SELECT 'SS616-092-S' UNION ALL
	SELECT 'SS616-092-M' UNION ALL
	SELECT 'SS616-092-L' UNION ALL
	SELECT 'SS616-092-XL' UNION ALL
	SELECT 'SS605-001-S' UNION ALL
	SELECT 'SS605-001-M' UNION ALL
	SELECT 'SS605-001-L' UNION ALL
	SELECT 'SS605-001-XL' UNION ALL
	SELECT 'SP627-340-S' UNION ALL
	SELECT 'SP627-340-M' UNION ALL
	SELECT 'SP627-340-L' UNION ALL
	SELECT 'SP627-340-XL' UNION ALL
	SELECT 'SP627-001-S' UNION ALL
	SELECT 'SP627-001-M' UNION ALL
	SELECT 'SP627-001-L' UNION ALL
	SELECT 'SP627-001-XL' UNION ALL
	SELECT 'SC988-627-1SFM' UNION ALL
	SELECT 'SC988-001-1SFM' UNION ALL
	SELECT 'SC988-340-1SFM' UNION ALL
	SELECT 'SC988-313-1SFM' UNION ALL
	SELECT 'SC988-609-1SFM' UNION ALL
	SELECT 'SC919-114-1SFM' UNION ALL
	SELECT 'SC919-740-1SFM' UNION ALL
	SELECT 'SC919-313-1SFM' UNION ALL
	SELECT 'SC919-647-1SFM' UNION ALL
	SELECT 'SC126-313-1SFM' UNION ALL
	SELECT 'SC126-311-1SFM' UNION ALL
	SELECT 'SC133-883-1SFM' UNION ALL
	SELECT 'SC133-311-1SFM' UNION ALL
	SELECT 'SO156-513-S' UNION ALL
	SELECT 'SO156-513-M' UNION ALL
	SELECT 'SO156-513-L' UNION ALL
	SELECT 'SO156-001-S' UNION ALL
	SELECT 'SO156-001-M' UNION ALL
	SELECT 'SO156-001-L' UNION ALL
	SELECT 'SN464-129-XS' UNION ALL
	SELECT 'SN464-129-S' UNION ALL
	SELECT 'SN464-129-M' UNION ALL
	SELECT 'SN464-129-L' UNION ALL
	SELECT 'SN464-129-XL' UNION ALL
	SELECT 'SN464-044-XS' UNION ALL
	SELECT 'SN464-044-S' UNION ALL
	SELECT 'SN464-044-M' UNION ALL
	SELECT 'SN464-044-L' UNION ALL
	SELECT 'SN464-044-XL' UNION ALL
	SELECT 'SN464-001-S' UNION ALL
	SELECT 'SN464-001-M' UNION ALL
	SELECT 'SN464-001-L' UNION ALL
	SELECT 'SN464-001-XL' UNION ALL
	SELECT 'SS454-001-XS' UNION ALL
	SELECT 'SS454-001-S' UNION ALL
	SELECT 'SS454-001-M' UNION ALL
	SELECT 'SS454-001-L' UNION ALL
	SELECT 'SS454-001-XL' UNION ALL
	SELECT 'SS222-313-XS' UNION ALL
	SELECT 'SS222-313-S' UNION ALL
	SELECT 'SS222-313-M' UNION ALL
	SELECT 'SS222-313-L' UNION ALL
	SELECT 'SS222-313-XL' UNION ALL
	SELECT 'SS222-311-XS' UNION ALL
	SELECT 'SS222-311-S' UNION ALL
	SELECT 'SS222-311-M' UNION ALL
	SELECT 'SS222-311-L' UNION ALL
	SELECT 'SS222-311-XL' UNION ALL
	SELECT 'SS222-647-S' UNION ALL
	SELECT 'SS222-647-M' UNION ALL
	SELECT 'SS222-647-L' UNION ALL
	SELECT 'SS222-647-XL' UNION ALL
	SELECT 'SS227-740-XS' UNION ALL
	SELECT 'SS227-740-S' UNION ALL
	SELECT 'SS227-740-M' UNION ALL
	SELECT 'SS227-647-XS' UNION ALL
	SELECT 'SS227-647-S' UNION ALL
	SELECT 'SS227-647-M' UNION ALL
	SELECT 'SS227-647-L' UNION ALL
	SELECT 'SS227-647-XL' UNION ALL
	SELECT 'SR207-040-S' UNION ALL
	SELECT 'SR207-040-M' UNION ALL
	SELECT 'SR207-040-L')

	INSERT INTO #PO_DATA (vendor_product_id) (
	SELECT 'SN701' UNION ALL
	SELECT 'SL856' UNION ALL
	SELECT 'SL521' UNION ALL
	SELECT 'SL858' UNION ALL
	SELECT 'SS616' UNION ALL
	SELECT 'SS605' UNION ALL
	SELECT 'SP627' UNION ALL
	SELECT 'SC079' UNION ALL
	SELECT 'SC988' UNION ALL
	SELECT 'SC919' UNION ALL
	SELECT 'SC126' UNION ALL
	SELECT 'SC133' UNION ALL
	SELECT 'SO156' UNION ALL
	SELECT 'SN464' UNION ALL
	SELECT 'SS454' UNION ALL
	SELECT 'SS222' UNION ALL
	SELECT 'SS227' UNION ALL
	SELECT 'SR207')
	
	DECLARE @config_string varchar(MAX)
	SET @config_string = '''''SW-SN701'''',''''SW-SL856'''',''''SW-SL521'''',''''SW-SL858'''',''''SW-SS616'''',''''SW-SS605'''',''''SW-SP627'''',''''SW-SC079'''',''''SW-SC988'''',''''SW-SC919'''',''''SW-SC126'''',''''SW-SC133'''',''''SW-SO156'''',''''SW-SN464'''',''''SW-SS454'''',''''SW-SS222'''',''''SW-SS227'''',''''SW-SR207'''''
...
EXEC Inline_Closeout_PO_Building 'SW-F13-1', 'Inline', 'SmartWool', 'SW', 103, 18
