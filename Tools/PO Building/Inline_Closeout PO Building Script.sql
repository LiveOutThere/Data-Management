...
BEGIN
	...
	SELECT '25430-001-O/S' UNION ALL
	SELECT '25430-2740-O/S' UNION ALL
	SELECT '25430-6278-O/S' UNION ALL
	SELECT '26680-1027-O/S' UNION ALL
	SELECT '15300-001-S' UNION ALL
	SELECT '15300-001-M' UNION ALL
	SELECT '15300-001-L' UNION ALL
	SELECT '15300-001-XL' UNION ALL
	SELECT '16640-001-XS' UNION ALL
	SELECT '16640-001-S' UNION ALL
	SELECT '16640-001-M' UNION ALL
	SELECT '16640-001-L' UNION ALL
	SELECT '16640-001-XL' UNION ALL
	SELECT '18410-001-XS' UNION ALL
	SELECT '18410-001-S' UNION ALL
	SELECT '18410-001-M' UNION ALL
	SELECT '18410-001-L' UNION ALL
	SELECT '18410-7404-XS' UNION ALL
	SELECT '18410-7404-S' UNION ALL
	SELECT '18410-7404-M' UNION ALL
	SELECT '18410-7404-L')

	INSERT INTO #PO_DATA (vendor_product_id) (
	SELECT '25430' UNION ALL
	SELECT '26680' UNION ALL
	SELECT '15300' UNION ALL
	SELECT '16640' UNION ALL
	SELECT '18410')
	
	DECLARE @config_string varchar(MAX)
	SET @config_string = '''''MAR-25430'''',''''MAR-26680'''',''''MAR-15300'''',''''MAR-16640'''',''''MAR-18410'''''
...
EXEC Inline_Closeout_PO_Building 'MAR-F13-2-HG-G', 'Inline', 'Marmot', 'MAR', 'FW13', 21, 5
