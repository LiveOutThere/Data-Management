...
BEGIN
	...
	SELECT '62253-519-XL' UNION ALL
	SELECT '62265-990-L' UNION ALL
	SELECT '62265-990-M' UNION ALL
	SELECT '62265-990-XL' UNION ALL
	SELECT '62282-254-L' UNION ALL
	SELECT '62282-254-M' UNION ALL
	SELECT '62300-222-L' UNION ALL
	SELECT '62300-222-M' UNION ALL
	SELECT '62300-222-S' UNION ALL
	SELECT '62252-545-L' UNION ALL
	SELECT '62252-545-M' UNION ALL
	SELECT '62252-545-XL' UNION ALL
	SELECT '62252-964-2XL' UNION ALL
	SELECT '62252-964-L' UNION ALL
	SELECT '62252-964-M' UNION ALL
	SELECT '62252-964-XL' UNION ALL
	SELECT '67002-981-O/S' UNION ALL
	SELECT '55964-001-L' UNION ALL
	SELECT '55964-001-M' UNION ALL
	SELECT '55964-001-S' UNION ALL
	SELECT '55964-964-L' UNION ALL
	SELECT '55964-964-M' UNION ALL
	SELECT '55964-964-S' UNION ALL
	SELECT '55964-964-XL' UNION ALL
	SELECT '62266-990-L' UNION ALL
	SELECT '62266-990-M' UNION ALL
	SELECT '62266-990-S' UNION ALL
	SELECT '62266-990-XL' UNION ALL
	SELECT '62282-254-S' UNION ALL
	SELECT '62282-254-XL' UNION ALL
	SELECT '62282-570-L' UNION ALL
	SELECT '62282-570-M' UNION ALL
	SELECT '62282-570-S' UNION ALL
	SELECT '62282-570-XL' UNION ALL
	SELECT '62290-689-L' UNION ALL
	SELECT '62290-689-M' UNION ALL
	SELECT '62290-689-S' UNION ALL
	SELECT '62253-519-L' UNION ALL
	SELECT '62253-519-M')

	INSERT INTO #PO_DATA (vendor_product_id) (
	SELECT '62253' UNION ALL
	SELECT '62265' UNION ALL
	SELECT '62282' UNION ALL
	SELECT '62300' UNION ALL
	SELECT '62252' UNION ALL
	SELECT '67002' UNION ALL
	SELECT '55964' UNION ALL
	SELECT '62266' UNION ALL
	SELECT '62290')
...
EXEC Inline_Closeout_PO_Building 'HH-S14-STAYDRY', 'Inline', 'Helly Hansen', 'HH', 'SS14', 39, 9
