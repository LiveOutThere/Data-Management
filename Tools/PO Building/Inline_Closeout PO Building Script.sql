...
BEGIN
	...
	SELECT '1154-2885-XS' UNION ALL
	SELECT '1154-2885-S' UNION ALL
	SELECT '1154-2885-M' UNION ALL
	SELECT '1154-2885-L' UNION ALL
	SELECT '1154-2885-XL' UNION ALL
	SELECT '1154-2910-XS' UNION ALL
	SELECT '1154-2910-S' UNION ALL
	SELECT '1154-2910-M' UNION ALL
	SELECT '1154-2910-L' UNION ALL
	SELECT '1154-2910-XL' UNION ALL
	SELECT '16480-4335-ONE' UNION ALL
	SELECT '16480-7203-ONE' UNION ALL
	SELECT '19280-1132-ONE' UNION ALL
	SELECT '19280-7203-ONE' UNION ALL
	SELECT '30320-001-S' UNION ALL
	SELECT '30320-001-M' UNION ALL
	SELECT '30320-001-L' UNION ALL
	SELECT '30320-001-XL' UNION ALL
	SELECT '30380-001-S' UNION ALL
	SELECT '30380-001-M' UNION ALL
	SELECT '30380-001-L' UNION ALL
	SELECT '30380-001-XL' UNION ALL
	SELECT '30380-2775-S' UNION ALL
	SELECT '30380-2775-M' UNION ALL
	SELECT '30380-2775-L' UNION ALL
	SELECT '30380-2775-XL' UNION ALL
	SELECT '35910-2538-XS' UNION ALL
	SELECT '35910-2538-S' UNION ALL
	SELECT '35910-2538-M' UNION ALL
	SELECT '35910-2538-L' UNION ALL
	SELECT '35910-2538-XL' UNION ALL
	SELECT '35910-6779-XS' UNION ALL
	SELECT '35910-6779-S' UNION ALL
	SELECT '35910-6779-M' UNION ALL
	SELECT '35910-6779-L' UNION ALL
	SELECT '35910-6779-XL' UNION ALL
	SELECT '40050-2775-S' UNION ALL
	SELECT '40050-2775-M' UNION ALL
	SELECT '40050-2775-L' UNION ALL
	SELECT '40050-2775-XL' UNION ALL
	SELECT '40050-4680-S' UNION ALL
	SELECT '40050-4680-M' UNION ALL
	SELECT '40050-4680-L' UNION ALL
	SELECT '40050-4680-XL' UNION ALL
	SELECT '41200-001-S' UNION ALL
	SELECT '41200-001-M' UNION ALL
	SELECT '41200-001-L' UNION ALL
	SELECT '41200-001-XL' UNION ALL
	SELECT '41200-2775-S' UNION ALL
	SELECT '41200-2775-M' UNION ALL
	SELECT '41200-2775-L' UNION ALL
	SELECT '41200-2775-XL' UNION ALL
	SELECT '41200-9185-S' UNION ALL
	SELECT '41200-9185-M' UNION ALL
	SELECT '41200-9185-L' UNION ALL
	SELECT '41200-9185-XL' UNION ALL
	SELECT '41260-001-S' UNION ALL
	SELECT '41260-001-M' UNION ALL
	SELECT '41260-001-L' UNION ALL
	SELECT '41260-001-XL' UNION ALL
	SELECT '46200-001-XS' UNION ALL
	SELECT '46200-001-S' UNION ALL
	SELECT '46200-001-M' UNION ALL
	SELECT '46200-001-L' UNION ALL
	SELECT '46200-2885-XS' UNION ALL
	SELECT '46200-2885-S' UNION ALL
	SELECT '46200-2885-M' UNION ALL
	SELECT '46200-2885-L' UNION ALL
	SELECT '46200-2885-XL' UNION ALL
	SELECT '46200-6778-XS' UNION ALL
	SELECT '46200-6778-S' UNION ALL
	SELECT '46200-6778-M' UNION ALL
	SELECT '46200-6778-L' UNION ALL
	SELECT '46200-6778-XL' UNION ALL
	SELECT '46260-001-XS' UNION ALL
	SELECT '46260-001-S' UNION ALL
	SELECT '46260-001-M' UNION ALL
	SELECT '46260-001-L' UNION ALL
	SELECT '46260-001-XL' UNION ALL
	SELECT '65480-1347-XS' UNION ALL
	SELECT '65480-1347-S' UNION ALL
	SELECT '65480-1347-M' UNION ALL
	SELECT '65480-1347-M' UNION ALL
	SELECT '65480-1347-L' UNION ALL
	SELECT '65480-1347-XL' UNION ALL
	SELECT '65480-2883-XS' UNION ALL
	SELECT '65480-2883-S' UNION ALL
	SELECT '65480-2883-M' UNION ALL
	SELECT '65480-2883-L' UNION ALL
	SELECT '65480-2883-XL' UNION ALL
	SELECT '80720-1452-S' UNION ALL
	SELECT '80720-1452-M' UNION ALL
	SELECT '80720-1452-L' UNION ALL
	SELECT '80720-1452-XL' UNION ALL
	SELECT '80720-4430-S' UNION ALL
	SELECT '80720-4430-M' UNION ALL
	SELECT '80720-4430-L' UNION ALL
	SELECT '80720-4430-XL' UNION ALL
	SELECT '80720-6684-S' UNION ALL
	SELECT '80720-6684-M' UNION ALL
	SELECT '80720-6684-L' UNION ALL
	SELECT '80720-6684-XL' UNION ALL
	...
	SELECT '80950-7037-30' UNION ALL
	SELECT '80950-7037-32' UNION ALL
	SELECT '80950-7037-34' UNION ALL
	SELECT '80950-7037-36' UNION ALL
	SELECT '80950-7037-38' UNION ALL
	...
	SELECT '85620-2538-XS' UNION ALL
	SELECT '85620-2538-S' UNION ALL
	SELECT '85620-2538-M' UNION ALL
	SELECT '85620-2538-L' UNION ALL
	SELECT '85620-2538-XL' UNION ALL
	SELECT '85620-2913-XS' UNION ALL
	SELECT '85620-2913-S' UNION ALL
	SELECT '85620-2913-S' UNION ALL
	SELECT '85620-2913-M' UNION ALL
	SELECT '85620-2913-L' UNION ALL
	SELECT '85620-2913-XL' UNION ALL
	SELECT '94330-001-XS' UNION ALL
	SELECT '94330-001-S' UNION ALL
	SELECT '94330-001-M' UNION ALL
	SELECT '94330-001-L' UNION ALL
	SELECT '63260-7203-30' UNION ALL
	SELECT '63260-7203-32' UNION ALL
	SELECT '63260-7203-34' UNION ALL
	SELECT '63260-7203-36' UNION ALL
	SELECT '63260-7203-38' UNION ALL
	SELECT '69310-1132-4' UNION ALL
	SELECT '69310-1132-6' UNION ALL
	SELECT '69310-1132-8' UNION ALL
	SELECT '69310-1132-10' UNION ALL
	SELECT '69310-1132-12')

	INSERT INTO #PO_DATA (vendor_product_id) (
	SELECT '1154' UNION ALL
	SELECT '16480' UNION ALL
	SELECT '19280' UNION ALL
	SELECT '30320' UNION ALL
	SELECT '30380' UNION ALL
	SELECT '35910' UNION ALL
	SELECT '40050' UNION ALL
	SELECT '41200' UNION ALL
	SELECT '41260' UNION ALL
	SELECT '46200' UNION ALL
	SELECT '46260' UNION ALL
	SELECT '65480' UNION ALL
	SELECT '80720' UNION ALL
	SELECT '80950' UNION ALL
	SELECT '85310' UNION ALL
	SELECT '85620' UNION ALL
	SELECT '94330' UNION ALL
	SELECT '63260' UNION ALL
	SELECT '69310')
	
	DECLARE @config_string varchar(MAX)
	SET @config_string = '''''MAR-1154'''',''''MAR-16480'''',''''MAR-19280'''',''''MAR-30320'''',''''MAR-30380'''',''''MAR-35910'''',''''MAR-40050'''',''''MAR-41200'''',''''MAR-41260'''',''''MAR-46200'''',''''MAR-46260'''',''''MAR-65480'''',''''MAR-80720'''',''''MAR-80950'''',''''MAR-85310'''',''''MAR-85620'''',''''MAR-94330'''',''''MAR-63260'''',''''MAR-69310'''''
...
EXEC Inline_Closeout_PO_Building 'MAR-S14-A1', 'Inline', 'Marmot', 'MAR', 'SS14', 143, 19
