...
BEGIN
	...
	SELECT 'A0SE-174-30-REG' UNION ALL
	SELECT 'A0SE-174-32-REG' UNION ALL
	SELECT 'A0SE-174-34-REG' UNION ALL
	SELECT 'A0SE-174-36-REG' UNION ALL
	SELECT 'A0SE-174-38-REG' UNION ALL
	SELECT 'A0SE-JK3-30-REG' UNION ALL
	SELECT 'A0SE-JK3-32-REG' UNION ALL
	SELECT 'A0SE-JK3-34-REG' UNION ALL
	SELECT 'A0SE-JK3-36-REG' UNION ALL
	SELECT 'A0SE-JK3-38-REG' UNION ALL
	SELECT 'A2V4-F9L-S' UNION ALL
	SELECT 'A2V4-F9L-M' UNION ALL
	SELECT 'A2V4-F9L-L' UNION ALL
	SELECT 'A2V4-F9L-XL' UNION ALL
	SELECT 'A2V4-KX7-S' UNION ALL
	SELECT 'A2V4-KX7-M' UNION ALL
	SELECT 'A2V4-KX7-L' UNION ALL
	SELECT 'A2V4-KX7-XL' UNION ALL
	SELECT 'A2V9-H1F-XS' UNION ALL
	SELECT 'A2V9-H1F-S' UNION ALL
	SELECT 'A2V9-H1F-M' UNION ALL
	SELECT 'A2V9-H1F-L' UNION ALL
	SELECT 'A2V9-VB3-S' UNION ALL
	SELECT 'A2V9-VB3-M' UNION ALL
	SELECT 'A2V9-VB3-L' UNION ALL
	SELECT 'A2W0-H1F-XS' UNION ALL
	SELECT 'A2W0-H1F-S' UNION ALL
	SELECT 'A2W0-H1F-M' UNION ALL
	SELECT 'A2W0-H1F-L' UNION ALL
	SELECT 'A2W0-H1F-XL' UNION ALL
	SELECT 'A2W0-JK3-S' UNION ALL
	SELECT 'A2W0-JK3-M' UNION ALL
	SELECT 'A2W0-JK3-L' UNION ALL
	SELECT 'A9PU-JK3-4-REG' UNION ALL
	SELECT 'A9PU-JK3-6-REG' UNION ALL
	SELECT 'A9PU-JK3-8-REG' UNION ALL
	SELECT 'A9PU-JK3-10-REG' UNION ALL
	SELECT 'A9PU-JK3-12-REG' UNION ALL
	SELECT 'AYET-J2Z-S' UNION ALL
	SELECT 'AYET-J2Z-M' UNION ALL
	SELECT 'AYET-J2Z-L' UNION ALL
	SELECT 'AYET-J2Z-XL' UNION ALL
	SELECT 'AYET-K5L-M' UNION ALL
	SELECT 'AYET-K5L-L' UNION ALL
	SELECT 'AYET-K5L-XL' UNION ALL
	SELECT 'CC55-15Q-S' UNION ALL
	SELECT 'CC55-15Q-M' UNION ALL
	SELECT 'CC55-15Q-L' UNION ALL
	SELECT 'CC55-15Q-XL' UNION ALL
	SELECT 'CC55-D1R-S' UNION ALL
	SELECT 'CC55-D1R-M' UNION ALL
	SELECT 'CC55-D1R-L' UNION ALL
	SELECT 'CC55-D1R-XL' UNION ALL
	SELECT 'CC55-JK3-S' UNION ALL
	SELECT 'CC55-JK3-M' UNION ALL
	SELECT 'CC55-JK3-L' UNION ALL
	SELECT 'CC55-JK3-XL' UNION ALL
	SELECT 'CC56-A0M-XS' UNION ALL
	SELECT 'CC56-A0M-S' UNION ALL
	SELECT 'CC56-A0M-M' UNION ALL
	SELECT 'CC56-A0M-L' UNION ALL
	SELECT 'CC56-A0M-XL' UNION ALL
	SELECT 'CC56-H1F-XS' UNION ALL
	SELECT 'CC56-H1F-S' UNION ALL
	SELECT 'CC56-H1F-M' UNION ALL
	SELECT 'CC56-H1F-L' UNION ALL
	SELECT 'CC56-H1F-XL' UNION ALL
	SELECT 'CC56-H2H-XS' UNION ALL
	SELECT 'CC56-H2H-S' UNION ALL
	SELECT 'CC56-H2H-M' UNION ALL
	SELECT 'CC56-H2H-L' UNION ALL
	SELECT 'CC56-H2H-XL')

	INSERT INTO #PO_DATA (vendor_product_id) (
	SELECT 'A0SE' UNION ALL
	SELECT 'A2V4' UNION ALL
	SELECT 'A2V9' UNION ALL
	SELECT 'A2W0' UNION ALL
	SELECT 'A9PU' UNION ALL
	SELECT 'AYET' UNION ALL
	SELECT 'CC55' UNION ALL
	SELECT 'CC56')
	
	DECLARE @config_string varchar(MAX)
	SET @config_string = '''''TNF-A0SE'''',''''TNF-A2V4'''',''''TNF-A2V9'''',''''TNF-A2W0'''',''''TNF-A9PU'''',''''TNF-AYET'''',''''TNF-CC55'''',''''TNF-CC56'''''
...
EXEC Inline_Closeout_PO_Building 'TNF-S14-S1', 'Inline', 'The North Face', 'TNF', 'SS14', 72, 8
